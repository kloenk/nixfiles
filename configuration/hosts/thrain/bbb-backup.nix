    ...
    systemd.services."${unitname}" = {
      ...
      script = ''
        ${pkgs.rsync}/bin/rsync -a -e "ssh -o UserKnownHostFile=/etc/bbb_hostkey -o IdentityFile=$CREDENTIALS_DIRECTORY/bbb_creds" \
          ssh://root@stream.unterbachersee.de:${dir}/ /var/lib/bbb_backup/${targetDir}/
      '';
...
in
{
  ...
  environment.etc."bbb_hostkey".text = "stream.unterbachersee.de,2a01:4f8:192:430b::2 ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBLqJOQVdy5FlBV77JPVHLMKd5hg1LGW4alDj52Aky3qj7hY95gwzFHnV8UoZqQmt+t4y2i/fT1vWdwDBfQY7zxM=";
