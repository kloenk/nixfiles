...
let
  inherit (common.mail) mxKloenk dmarcKloenk spfKloenk;
  ...
  zone = with dns.combinators; {
    ...
    subdomains = rec {
      ...
      net.subdomains = common.net // {
        acme =
          common.helpers.hostTTL 600 null "2a01:4f8:c013:1a4b:ecba:1337::1";
      };
      ...
      pve-usee =
        common.helpers.hostTTL 1800 "5.9.118.73" "2a01:4f8:162:6343::2";
