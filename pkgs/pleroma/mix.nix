{
  ...
  linkify = {
    buildTool = "mix";
    fetchHex = {
      sha256 = "f881eb3429ae88010cf736e6fb3eed406c187bcdd544902ec937496636b7c7b3";
      url = "https://repo.hex.pm/tarballs/linkify-0.4.1.tar";
    };
    version = "0.4.1";
  };
  postgrex = {
  ...
  ssl_verify_fun = {
    buildTool = "mix";
    fetchGit = {
      rev = "c5718226b0b9f3d1a38ef6ca3c3b4c75f53dda92";
      url = "https://github.com/deadtrickster/ssl_verify_fun.erl";
    };
    version = "c5718226b0b9f3d1a38ef6ca3c3b4c75f53dda92";
  };
  ex_aws = {
    buildTool = "mix";
    deps = [
    ...
    fetchHex = {
      sha256 = "41ab8b4caa48035c96d07faa035d2d9de6df480e7e084c054e662ac888dcd4d4";
      url = "https://repo.hex.pm/tarballs/ex_aws-2.1.6.tar";
    };
    version = "2.1.6";
  };
  ecto_sql = {
  ...
  unicode_util_compat = {
    buildTool = "mix";
    fetchGit = {
      rev = "38d7bc105f51159e8ea3279c40121db9db1e652f";
      url = "https://github.com/benoitc/unicode_util_compat.git";
    };
    version = "38d7bc105f51159e8ea3279c40121db9db1e652f";
  };
  connection = {
    buildTool = "mix";
    fetchHex = {
  ...
  metrics = {
    buildTool = "mix";
    fetchGit = {
      rev = "c6eb4dcf29f9e907539915e2ab996f40c2ec7e8e";
      url = "https://github.com/benoitc/erlang-metrics";
    };
    version = "c6eb4dcf29f9e907539915e2ab996f40c2ec7e8e";
  };
  base62 = {
    buildTool = "mix";
    deps = [
  ...
  hackney = {
    buildTool = "mix";
    fetchGit = {
      rev = "7d7119f0651515d6d7669c78393fd90950a3ec6e";
      url = "https://git.pleroma.social/pleroma/elixir-libraries/hackney.git";
    };
    version = "7d7119f0651515d6d7669c78393fd90950a3ec6e";
  };
  idna = {
    buildTool = "mix";
    fetchGit = {
      rev = "6cff72747821110169ecfac871b0c69e5064afff";
      url = "https://github.com/benoitc/erlang-idna";
    };
    version = "6cff72747821110169ecfac871b0c69e5064afff";
  };
  eternal = {
    buildTool = "mix";
    fetchHex = {
  ...
  certifi = {
    buildTool = "mix";
    fetchGit = {
      rev = "e08b12e8993502240c25b78563993776f87ecd2a";
      url = "https://github.com/certifi/erlang-certifi";
    };
    version = "e08b12e8993502240c25b78563993776f87ecd2a";
  };
  flake_id = {
    buildTool = "mix";
    deps = [
  ...
  parse_trans = {
    buildTool = "mix";
    fetchGit = {
      rev = "76abb347c3c1d00fb0ccf9e4b43e22b3d2288484";
      url = "https://github.com/uwiger/parse_trans.git";
    };
    version = "76abb347c3c1d00fb0ccf9e4b43e22b3d2288484";
  };
  myhtmlex = {
    buildTool = "mix";
    fetchGit = {
  ...
  mimerl = {
    buildTool = "mix";
    fetchGit = {
      rev = "5a1b22a8fada5b3b40438da00a6923cb87a42bbc";
      url = "https://github.com/benoitc/mimerl";
    };
    version = "5a1b22a8fada5b3b40438da00a6923cb87a42bbc";
  };
  swoosh = {
    buildTool = "mix";
    deps = [
