...
let
  buildPlugin = { name ? builtins.baseNameOf url, url, sha256, ...  }@extraArgs: callPackage ({fetchurl, stdenv, unzip }: stdenv.mkDerivation {
    inherit name;
    src = fetchurl {
      inherit url sha256;
    };
...
in {
  ...
  podlove = {
    publisher = buildPlugin {
      url = "https://downloads.wordpress.org/plugin/podlove-podcasting-plugin-for-wordpress.3.2.2.zip";
      sha256 = "bae104fe1a36c8326251a27d65b69419762f5ead83fd0c182c1df7f8449b21fa";
    };
    button = buildPlugin {
      url = "https://downloads.wordpress.org/plugin/podlove-subscribe-button.1.3.7.zip";
      sha256 = "a475797f2c4b6d557b464ee82f839c5c16a90527ea406aebe03d83b42da57d3e";
    };
    player = buildPlugin {
      url = "https://downloads.wordpress.org/plugin/podlove-web-player.zip";
      sha256 = "c6d96e5c407835edaadff7b075f4224badfbe48481f285d2d4e2b4967cd80f91";
    };
  };
